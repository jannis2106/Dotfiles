...
local weather =
    ...
    units = "metric", 
    lang = "de",
    -- current_call = string.format("curl -s 'http://api.openweathermap.org/data/2.5/weather?id=%s&units=%s&lang=%s&APPID=%s'", secrets.city_id_home, "metric", "de", secrets.APPID)
    
    current_call = "curl -s 'http://api.openweathermap.org/data/2.5/weather?id=2904789&units=metric&lang=de&APPID=ef43a99045ed7fa2aaf9492f8e3cf22d'",
