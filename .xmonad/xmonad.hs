...
--
main = do
    xmproc <- spawnPipe "xmobar /home/jannis/.conifg/xmobar/xmobarrc"
    xmonad $ docks $ defaults
        {
            layoutHook = spacingWithEdge 5 $ myLayout
          , logHook = dynamicLogWithPP $ xmobarPP
                { ppOutput = hPutStrLn xmproc
                , ppCurrent = xmobarColor "#e95678" "" . wrap "[" "]"
                , ppVisible = xmobarColor "#f2f2f2" ""
                , ppHidden = xmobarColor "#29d398" "" . wrap "*" ""
                , ppHiddenNoWindows = xmobarColor "#fab795" ""
                , ppTitle = xmobarColor "#b3afc2" "" . shorten 50
                , ppSep = "<fc=#383838>|</fc>"
                , ppUrgent = xmobarColor "#29d398" "" . wrap "!" "!"
                }
        }
